...
const (
	RUNS_ON_ARM32          RunsOn = "ARM32"
	RUNS_ON_LINUX          RunsOn = "linux"
	RUNS_ON_MACOS          RunsOn = "macos"
	RUNS_ON_MACOS_10_15    RunsOn = "macos-10.15"
	RUNS_ON_MACOS_11_0     RunsOn = "macos-11.0"
	RUNS_ON_MACOS_LATEST   RunsOn = "macos-latest"
	RUNS_ON_SELF_HOSTED    RunsOn = "self-hosted"
	RUNS_ON_UBUNTU_16_04   RunsOn = "ubuntu-16.04"
	RUNS_ON_UBUNTU_18_04   RunsOn = "ubuntu-18.04"
	RUNS_ON_UBUNTU_20_04   RunsOn = "ubuntu-20.04"
	RUNS_ON_UBUNTU_LATEST  RunsOn = "ubuntu-latest"
	RUNS_ON_WINDOWS        RunsOn = "windows"
	RUNS_ON_WINDOWS_2016   RunsOn = "windows-2016"
	RUNS_ON_WINDOWS_2019   RunsOn = "windows-2019"
	RUNS_ON_WINDOWS_LATEST RunsOn = "windows-latest"
	RUNS_ON_X64            RunsOn = "x64"
	RUNS_ON_X86            RunsOn = "x86"
)
